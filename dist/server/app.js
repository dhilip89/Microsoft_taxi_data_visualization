...
var App = function () {
    ...
    _createClass(App, [{
        ...
        value: function run() {
            ...
            app.use("/data", _express2.default.static(_path2.default.join(__dirname, '../../data'))); // 数据文件
            app.use("/config", _express2.default.static(_path2.default.join(__dirname, '../../config'))); //配置文件
